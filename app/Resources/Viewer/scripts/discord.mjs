	...
	return {
		setup() {
			...
			templateAttachmentDownload = new template([
				"<a href='{url}' target='_blank' class='embed download'>Download {name}</a>"
			].join(""));
			
			// noinspection HtmlUnknownTarget
			templateEmbedImage = new template([
				"<a href='{url}' target='_blank' class='embed thumbnail loading'><img src='{src}' alt='' onload='window.DISCORD.handleImageLoad(this)' onerror='window.DISCORD.handleImageLoadError(this)'></a><br>"
			].join(""));
			
			// noinspection HtmlUnknownTarget
			templateEmbedImageWithSize = new template([
				"<a href='{url}' target='_blank' class='embed thumbnail loading'><img src='{src}' width='{width}' alt='' onload='window.DISCORD.handleImageLoad(this)' onerror='window.DISCORD.handleImageLoadError(this)'></a><br>"
			].join(""));
			
			// noinspection HtmlUnknownTarget
			templateEmbedRich = new template([
				"<div class='embed download'><a href='{url}' target='_blank' class='title'>{title}</a><p class='desc'>{description}</p></div>"
			].join(""));
			
			// noinspection HtmlUnknownTarget
			templateEmbedRichNoDescription = new template([
				"<div class='embed download'><a href='{url}' target='_blank' class='title'>{title}</a></div>"
			].join(""));
			
			// noinspection HtmlUnknownTarget
			templateEmbedUrl = new template([
				"<a href='{url}' target='_blank' class='embed download'>{url}</a>"
			].join(""));
