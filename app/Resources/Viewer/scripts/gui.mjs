...
<label><input id='dht-cfg-animemoji' type='checkbox'> Animated Emoji</label><br>`);
	...
	const showInfoModal = function() {
		...
		showModal(560, `
<p>Discord History Tracker is developed by <a target='_blank' href='https://chylex.com'>chylex</a> as an <a target='_blank' href='${linkGH}/blob/master/LICENSE.md'>open source</a> project.</p>
<p>Please, report any issues and suggestions to the <a target='_blank' href='${linkGH}/issues'>tracker</a>. If you want to support the development, please spread the word and consider <a target='_blank' href='https://www.patreon.com/chylex'>becoming a patron</a> or <a target='_blank' href='https://ko-fi.com/chylex'>buying me a coffee</a>. Any support is appreciated!</p>
<p><a href='${linkGH}/issues'>Issue Tracker</a> &nbsp;&mdash;&nbsp; <a target='_blank' href='${linkGH}'>GitHub Repository</a> &nbsp;&mdash;&nbsp; <a target='_blank' href='https://twitter.com/chylexmc'>Developer's Twitter</a></p>`);
	};
